...
const record = createSlice({
  ...
  reducers: {
    getMyRecords: (state, action) => {
      return { ...state, myRecords: action.payload };
    },
    getMyRecordsInFull: (state, action) => {
      return { ...state, myRecordsInFull: action.payload };
    },
    getSelectedRecord: (state, action) => {
      return { ...state, selectedRecord: action.payload };
    },
    getCreatedRecord: (state, action) => {
      return { ...state, createdRecord: action.payload };
    },
  },
});
